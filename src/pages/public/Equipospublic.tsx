...
// export default function EquiposPublic() {
...
//       try {
//         // Nota: Aquí llamamos al endpoint público SIN token ni headers
//         const [equiposRes, posicionesRes] = await Promise.all([
//           fetch("https://nestjs-cancha-backend-api.desarrollo-software.xyz/equipos"),
//           fetch("https://nestjs-cancha-backend-api.desarrollo-software.xyz/tabla-posiciones"),
//         ]);

//         if (!equiposRes.ok || !posicionesRes.ok) {
...
//                 <td>
//                   <img
//                     src={equipo.escudoUrl.startsWith("data:") ? equipo.escudoUrl : `/imagenes/${equipo.escudoUrl}`}
//                     alt={equipo.nombre}
//                     width={50}
//                     height={50}
